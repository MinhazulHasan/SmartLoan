...
namespace SmartLoan.Migrations
{
    ...
    [Migration("20221229091905_AddSubmissionPeriodCategoryToDb")]
    partial class AddSubmissionPeriodCategoryToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartLoan.Models.InstallmentMaster", b =>
                {
                    ...
                    b.Property<double>("SubmittedAmountToOffice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("SmartLoan.Models.LoanOfficeCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InstallmentMasterId");

                    b.ToTable("LoanOfficeCollections");
                });
            ...
            modelBuilder.Entity("SmartLoan.Models.UsersLoginSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartLoan.Models.LoanOfficeCollection", b =>
                {
                    b.HasOne("SmartLoan.Models.InstallmentMaster", "InstallmentMaster")
                        .WithMany()
                        .HasForeignKey("InstallmentMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InstallmentMaster");
                });
